...
Elm.Main.make = function (_elm) {
   ...
   $TodoList = Elm.TodoList.make(_elm);
...
Elm.Todo.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var removeView = function (context) {
   ...
   var todoTitleStyle = function (done) {
      return function () {
         var textDecoration = done ? "line-through" : "inherit";
   ...
   var todoEdit = F2(function (address,
   editing) {
      return editing ? A2($Html.a,
      _L.fromArray([$Html$Attributes.href("#")
                   ,A2($Html$Events.onClick,
                   address,
                   ToggleEdit)]),
      _L.fromArray([$Html.text("done")])) : A2($Html.a,
      _L.fromArray([$Html$Attributes.href("#")
                   ,A2($Html$Events.onClick,
                   address,
                   ToggleEdit)]),
   ...
   var todoText = F2(function (address,
   model) {
      return model.editing ? A2($Html.input,
      _L.fromArray([$Html$Attributes.type$("text")
                   ...
                   function ($) {
                      return $Signal.message(address)(Rename($));
                   })]),
      _L.fromArray([])) : A2($Html.span,
      _L.fromArray([todoTitleStyle(model.done)]),
      _L.fromArray([$Html.text(model.title)]));
   });
   var todoCheckbox = F4(function (address,
   model,
   action,
   contextual) {
   ...
   var viewWithContext = F3(function (context,
   model,
   views) {
      return function () {
         var contextual = A2($List.map,
         function (v) {
            return v(context);
         },
         views);
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 return A3($Todo.viewWithContext,
                 context,
                 _v12._1,
                 _L.fromArray([$Todo.removeView]));
              }();}
         _U.badCase($moduleName,
